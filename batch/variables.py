...
PRODUCT_OTHER_DATA_PATH: str = os.path.join(SAVE_PATH, "product_other_data.csv")
PRODUCT_US_DATA_PATH: str = os.path.join(SAVE_PATH, "product_us_data.csv")
...
# 상품 관련 블로그/카페/뉴스글 송신, 상품서비스부 정우열
PRODUCT_CHANNEL_ID: str = "219f58a8-f62f-88b5-e5dc-40b49ad949b7"  # FIXME
