...
class BlogItem(BaseModel):
    title: str = Field(..., title="포스트 제목", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
    link: str = Field(..., title="포스트 URL")
    description: str = Field(..., title="포스트 요약", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
...
class NewsItem(BaseModel):
    title: str = Field(..., title="뉴스 제목", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
    originallink: str = Field(..., title="기사 원문 URL")
    link: str = Field(..., title="네이버 뉴스 URL 또는 원문 URL")
    description: str = Field(..., title="기사 요약", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
...
class CafeItem(BaseModel):
    title: str = Field(..., title="게시글 제목", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
    link: str = Field(..., title="게시글 URL")
    description: str = Field(..., title="게시글 요약", description="검색어와 일치하는 부분은 <b> 태그로 감싸짐")
